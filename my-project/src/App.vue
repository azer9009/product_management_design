    ...
    <aside class="py-6 px-10 w-64 border-r border-gray-200">
      ...
      <ul v-for="group in sidebar" class="flex flex-col gap-y-6 pt-20">
        <li v-for="item in group">
          ...
          <span class="absolute w-1.5 h-8 bg-indigo-600 rounded-r-full left-0 scale-y-0 -translate-x-full group-hover:scale-y-100 group-hover:translate-x-0 ease-in-out"></span>
    ...
    <main class="flex-1 pb-8">
      <div class="flex items-center justify-between py-7 px-10">
        ...
        <p class="text-sm font-medium text-gray-500">
          Let's grow to your businnes! Create your product and upload here
        </p>
      </div>
      ...
      <ul class="flex gap-x-24 items-center px-4 border-y border-gray-200">
        <li v-for="item in status">
          <button class="flex gap-x-2 items-center py-5 px-6 text-gray-500 hover:text-indigo-600 relative group">
            <Component :is="item.icon" class="w-6 h- fill-current" />
          ...
          <tr
            ...
            <td>
              <div class="flex gap-x-2 justify-center items-center">
                <a href="#" v-for="icon in product.platformIcons" class="p-2 bg-gray-200 rounded-md hover:bg-gray-300">
            ...
            <td>
              <span class="inline-block w-20 group-hover:hidden">{{ product.createdAt }}</span>
              <div class=" hidden group-hover:flex group-hover:items-center group-hover:text-gray-500 group-hover:gap-x-2 group-hover:w-20">
      ...
      <div class="flex gap-x-2 justify-center pt-8">
        ...
        <button v-for="i in 6" class="flex items-center justify-center w-8 h-8 font-medium rounded-full"
        :class="i === 1 ? ' bg-gray-800 text-white' : 'text-gray-400 hover:text-indigo-600'">
        {{ i }}
